...
Once the `conda-forge` channel has been enabled, `fps-login` can be installed with:

```
conda install fps-login
```

It is possible to list all of the versions of `fps-login` available on your platform with:
